...
int main()
{
    try {
        ...
        puts("PASS: HDR10 PQ luminance, HDR shader compilation, highlights, signed gamut, zero-edit identity, bypass, wipe, finite edits, SDR output, channel order and 180 rotation (WARP)");
        return 0;
